...
3. Create a fixup commit and push to your GitHub repository (this will update your Pull Request):
   ...
   For more info on working with fixup commits see [here](https://github.com/angular/angular/blob/main/contributing-docs/using-fixup-commits.md).
...
- We follow [Google's TypeScript Style Guide][ts-style-guide], but wrap all code at **100 characters**.
  ...
  An automated formatter is available, see [building-and-testing-angular.md](https://github.com/angular/angular/blob/main/contributing-docs/building-and-testing-angular.md#formatting-your-source-code).
...
[dev-doc]: https://github.com/angular/angular/blob/main/contributing-docs/building-and-testing-angular.md
